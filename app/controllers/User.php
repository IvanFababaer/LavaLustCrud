...
class User extends Controller {
    ...
    public function create() {
        if ($this->form_validation->submitted()) {
            $idf_last_name = $this->io->post('last_name');
            $idf_first_name = $this->io->post('first_name');
            $idf_email = $this->io->post('email');
            $idf_gender = $this->io->post('gender');
            $idf_address = $this->io->post('address');

            $this->call->model('user_model');
            $this->user_model->createUsers($idf_last_name, $idf_first_name, $idf_email, $idf_gender, $idf_address);
    ...
    public function update($id) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
            ...
            $this->user_model->updateUsers($id, $idf_last_name, $idf_first_name, $idf_email, $idf_gender, $idf_address);
